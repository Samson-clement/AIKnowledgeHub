    ...
    <div className="flex justify-center items-center h-screen bg-gradient-to-br from-darkblue to-black relative">
      ...
      <div className="flex flex-col w-full h-full relative">
        <div className="w-full h-full p-8 px-10 lg:px-20 pt-2 flex flex-col justify-center text-center items-center align-middle">
          <h1 className="text-3xl lg:text-5xl font-bold fontS mb-4 text-white"> HANDWRITING TO TEXT</h1>
          <p className="text-xl text-gray-300">Upload the image of your handwriting and preview the text below</p>
          ...
          <div className="lg:w-2/3 text-center">
            ...
            {imagePreview &&
              <> <p className="text-white font-bold underline text-start">Preview:</p>
                <img src={imagePreview} alt="Preview" className="mt-4 border border-gray-500 rounded" style={{ maxWidth: '100%', maxHeight: '200px' }} />
              </>
            }
